...
export function Footer() {
  ...
  console.log('🚀 ~ Footer ~ footerLogoData:', footerLogoData);
  ...
  return (
    <footer>
        ...
        >
          <div className='flex flex-col items-center gap-7'>
            {footerLogoData ? (
              ...
              <div className='font-medium text-base uppercase'>{shopName}</div>
            )}
      ...
      <div
        className={cn(
          'w-full bg-background text-body py-4 lg:py-6',
          variants({ padding: footerWidth })
        )}
      >
        <div
          className={cn(
            'py-4 flex gap-4 flex-col lg:flex-row justify-between items-center',
            variants({ width: footerWidth })
          )}
        >
          <p>{copyright}</p>
...
function FooterMenu() {
  ...
  return (
    <Accordion.Root
      ...
      className='w-full grid lg:grid-cols-3 lg:gap-8 lg:col-span-3'
    >
