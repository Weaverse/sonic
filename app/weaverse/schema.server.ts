    ...
    },
    {
      ...
      inputs: [
...

        {
          ...
          label: 'Logo',
          defaultValue: {
            id: 'gid://shopify/MediaImage/41969467556134',
            url: 'https://cdn.shopify.com/s/files/1/0940/9318/1222/files/sonic_logo.png?v=1743153630',
            width: 138,
            height: 44,
            altText: 'sonic logo.png',
          },
        },
        {
          type: 'image',
    ...
    },
    {
      ...
      inputs: [
        ...
        },
        {
          ...
          label: 'Store bio',
          defaultValue:
            '<p>Unlock exclusive discounts, new arrivals, and daily deals.</p>',
        },
        {
          type: 'heading',
          label: 'Social links',
