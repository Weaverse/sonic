<h1 align="center">Sonic - Shopify Hydrogen Theme</h1>

<div align="center">

📚 [Read the docs](https://weaverse.io/docs) | 🗣 [Join our community on Slack](https://join.slack.com/t/weaversecommunity/shared_invite/zt-235bv7d80-velzJU8CpZIHWdrzFwAdXg) | 🐞 [Report a bug](https://github.com/weaverse/sonic/issues)

</div>

![Weaverse + Hydrogen + Shopify](https://cdn.shopify.com/s/files/1/0693/8201/3220/files/Logos.png?v=1695811776)

_Sonic is a Shopify Hydrogen theme built with Weaverse, Sonic delivers authentic, cutting-edge design tailored for tech enthusiasts, empowering seamless online stores for electronics and gadgets._

## Demo

- Live store: https://sonic.weaverse.dev
- Customizing Sonic on Weaverse Studio: https://studio.weaverse.io/demo?theme=aspen
...
**Follow these steps to get started with Sonic and begin crafting your Hydrogen-driven storefront:**
...
Let **Weaverse** & **Sonic** empower your Shopify store with top-notch performance and unmatched customization possibilities! 🚀
